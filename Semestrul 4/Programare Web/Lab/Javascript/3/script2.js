...
function flipBack() {
	...
	document.getElementById(tileIDs[0]).style.background = "#222";
    document.getElementById(tileIDs[1]).style.background = "#222"
    clickedValues = [];
	tileIDs = [];
}
...
function flip(tile, val)
{
	...
	{
		tile.style.background = "url(images/" + val + ".jpg) no-repeat";
