...
/*
 *  Returneaza stocul din farmacie de cantitatea primita ca parametru
 *  param farmacie: Farmacia cu medicamentele
 *  param concentratie: concentratia dupa care se cauta (float)
 *  return: stocul (int)
 */

int getAllStocConcentratie(Farmacie* farmacie, float concentratie);
...
/*
* Face undo al ultimei operatii
* param farmacie: Farmacia cu medicamente
* return - 1 daca s-a facut undo
*        - 0 daca nu s-a facut undo, daca lista este goala
*/
...
void testSortNumeD();
void testUndo();
void testgetAllStocConcentratie();