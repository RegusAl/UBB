...
class Console:
    ...
    def __print_ratings(self, rating_list):
        ...
        if len(rating_list) == 0:
            ...
            for rating in rating_list:
                # print(rating)
                print('Serial: [', colored(str(rating.getSerial().getTitle()), 'cyan'), '; ',
                      colored(str(rating.getSerial().getAnAparitie()), 'cyan'), ']',
                      'Client: [', colored(str(rating.getClient().getNume()), 'magenta'), ';',
                      colored(str(rating.getClient().getVarsta()), 'magenta'), ']', 'Rating: ', colored(str(
    ...
    def __create_rating_report(self):
        ...
        for show_rating in show_rating_infos:
            print('Serial:', colored(show_rating.getTitluSerial(), 'cyan'), 'Numar rating-uri:',
                  colored(str(show_rating.getNoRatings()), 'magenta'), 'Avg. no. stars:',
                  colored(str(show_rating.getAvgNoStars()), 'magenta'), ' Medie varsta:',
                  colored(str(show_rating.getMedieVarsta()), 'blue'))
